...
public class UserMealAjaxController extends AbstractUserMealController {
    ...
    public ResponseEntity<String> createOrUpdate(@Valid UserMealTo userMealTo, BindingResult result) {
        if (result.hasErrors()) {
        ...
        if (userMealTo.getId() == 0) {
            create(UserMealsUtil.createFromTo(userMealTo));
        } else {
            update(UserMealsUtil.createFromTo(userMealTo), userMealTo.getId());
        }
